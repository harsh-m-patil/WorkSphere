...
const Freelancersignup = () => {
  ...
  return (
    <div className="overflow-hidden">
      <div className="mx-auto mt-8 max-w-lg rounded-lg bg-white p-8 shadow-xl">
        {' '}
        ...
        {/* <div className="absolute bottom-[-120px] right-[-400px] flex h-[350px] w-[950px] rotate-[-45] skew-x-6 scale-110 transform items-center justify-center rounded-full bg-[rgba(30,160,170,0.1)] blur-lg"></div>
        {/* Applied larger shadow */}
        {/* <div className="absolute right-[-400px] top-[-120px] flex h-[350px] w-[950px] rotate-12 skew-x-6 scale-110 transform items-center justify-center rounded-full bg-[rgba(30,160,170,0.1)] blur-lg"></div> */}
