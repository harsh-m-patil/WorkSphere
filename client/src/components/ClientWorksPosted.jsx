                ...
                {WorksByMe.length > 0 ? (
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {WorksByMe.map((work) => (
                            <div
                                key={work._id}
                                className="group cursor-pointer rounded-lg border border-gray-200 bg-slate-200 p-6 shadow-md hover:shadow-lg transition-shadow"
                            ...
                            >
                                ...
                                <div className="mt-4">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        <strong>Freelancers Applied:</strong> {work.applied_status.length}
                                    </p>
