  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="relative bg-white py-20">
        ...
        <div className="absolute left-1/2 top-1/2 z-0 flex h-[450px] w-[850px] translate-x-[40%] translate-y-[-85%] rotate-[-35deg] skew-x-6 scale-110 transform items-center justify-center gap-10 overflow-hidden rounded-full bg-[rgba(30,160,170,0.1)] blur-lg"></div>
        ...
        <div
          ref={introRef}
          className={`z-10 mx-auto max-w-7xl px-6 text-center transition-transform duration-1000 sm:px-8 ${
            introInView
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600">
            WorkSphere is a leading platform connecting talented freelancers
            with businesses in need of specialized skills. We provide a diverse
            range of freelance opportunities to empower individuals to build
            their careers while helping businesses find the perfect talent. Our
            platform helps both freelancers and businesses to create meaningful
            partnerships.
            <br />
            <br />
            Whether you’re looking for a long-term project or a one-time gig, we
            offer flexibility and a vast pool of talented professionals. Our
            mission is to empower freelancers and help businesses thrive by
      ...
      <div
        ref={leaderRef}
        className={`bg-white py-24 transition-transform duration-1000 sm:py-32 ${
          leaderInView
            ? 'translate-y-0 scale-100 opacity-100 shadow-lg'
            : 'translate-y-10 scale-90 opacity-0'
        }`}
      >
        <div className="mx-auto max-w-7xl rounded-lg border-4 border-gray-300 bg-white px-6 py-12 transition-all duration-1000 ease-in-out lg:px-8">
                    ...
                    {person.link ? (
                      ...
                      >
                        <img
                          alt={person.name}
                          src={person.imageUrl}
                          className="h-16 w-16 rounded-full border border-gray-300 shadow-md transition-transform duration-300 group-hover:scale-110"
                        />
                      </a>
                    ) : (
                      <img
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600">
            Have any questions or need assistance? Contact us through the
            following channels:
          </p>
